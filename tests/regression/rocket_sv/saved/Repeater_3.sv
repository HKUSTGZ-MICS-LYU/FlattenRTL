...
module Repeater_3(
  ...
  wire        _GEN = _io_enq_ready_output & io_enq_valid & io_repeat;	// src/main/scala/util/Repeater.scala:24:32, :28:21
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_mask = _RANDOM[2'h1][7:0];	// src/main/scala/util/Repeater.scala:20:18
        saved_data = {_RANDOM[2'h1][31:8], _RANDOM[2'h2], _RANDOM[2'h3][7:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h3][8];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
