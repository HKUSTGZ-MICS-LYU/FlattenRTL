...
module Queue_20(
  ...
  assign io_deq_bits_data = ram[63:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_strb = ram[71:64];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  assign io_deq_bits_last = ram[72];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
