...
module MulDiv(
  ...
  wire         _io_resp_valid_output = state == 3'h6 | (&state);	// src/main/scala/rocket/Multiplier.scala:48:22, :122:13, :178:{27,42,51}
  ...
  wire         _GEN_2 = _GEN_1 & count == 7'h3F;	// src/main/scala/rocket/Multiplier.scala:51:18, :98:57, :103:{39,50}, :121:{25,55}, :122:13
  wire         _GEN_3 = state == 3'h3;	// src/main/scala/rocket/Multiplier.scala:48:22, :96:11, :126:39
  wire         _GEN_4 = count == 7'h40;	// src/main/scala/rocket/Multiplier.scala:51:18, :116:38, :135:17
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      count <= {1'h0, cmdMul & ~io_req_bits_dw, 5'h0};	// src/main/scala/rocket/Multiplier.scala:51:18, :72:107, :75:60, :115:13, :165:{11,38,46}
