...
module mips_16_core_top (
    ...
    instruction_mem   IF_stage_inst___imem (. clk ( IF_stage_inst___clk ),. pc ( IF_stage_inst___pc ),. instruction ( IF_stage_inst___instruction ));
  ...
  assign  ID_stage_inst___decoding_op_src2 =(((( ID_stage_inst___ir_op_code ==4'b0000)||( ID_stage_inst___ir_op_code ==4'b1001))||( ID_stage_inst___ir_op_code ==4'b1010))||( ID_stage_inst___ir_op_code ==4'b1100) ? 3'b000: ID_stage_inst___ir_src2 );
    ...
    alu   EX_stage_inst___alu_inst (. a ( EX_stage_inst___alu_src1 ),. b ( EX_stage_inst___alu_src2 ),. cmd ( EX_stage_inst___alu_cmd ),. r ( EX_stage_inst___ex_alu_result )); 
  ...
  assign  EX_stage_inst___ex_op_dest = EX_stage_inst___pipeline_reg_in [3:1];
    ...
    data_mem   MEM_stage_inst___dmem (. clk ( MEM_stage_inst___clk ),. mem_access_addr ( MEM_stage_inst___ex_alu_result ),. mem_write_data ( MEM_stage_inst___mem_write_data ),. mem_write_en ( MEM_stage_inst___mem_write_en ),. mem_read_data ( MEM_stage_inst___mem_read_data )); 
